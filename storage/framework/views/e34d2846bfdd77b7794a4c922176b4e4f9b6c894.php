...
<?php $component->withAttributes(['class' => 'p-10 max-w-lg mx-auto mt-24']); ?>
            ...
            <form method="POST" action="<?php echo e(url('/listings/'.$listing->id)); ?>" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
$message = $__bag->first($__errorArgs[0]); ?>
                        <p class="inline-block text-sm text-laravel"><?php echo e($message); ?></p>
                    <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-6">
                    ...
                    <img class="hidden w-48 mr-6 md:block" src="<?php echo e($listing->logo ? asset('storage/'.$listing->logo):asset('images/no-image.png')); ?>" alt="" loading="lazy"/>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-6">
                    ...
                    <a href="<?php echo e(url()->previous()); ?>" class="text-black ml-4"> Back </a>
                </div>
            </form>
...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
<?php /**PATH D:\Laravel-projects\laragigs\resources\views/listings/edit-listing.blade.php ENDPATH**/ ?>