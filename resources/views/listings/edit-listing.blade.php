        ...
        <x-card class="p-10 max-w-lg mx-auto mt-24">
            ...
            <form method="POST" action="{{ url('/listings/'.$listing->id) }}" enctype="multipart/form-data">
                ...
                <div class="mb-6">
                    ...
                    @error('company')
                        <p class="inline-block text-sm text-laravel">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mb-6">
                    ...
                    <img class="hidden w-48 mr-6 md:block" src="{{ $listing->logo ? asset('storage/'.$listing->logo):asset('images/no-image.png') }}" alt="" loading="lazy"/>
